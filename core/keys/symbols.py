...
old_symbols = [
    Symbol("`", None, ["back tick"]),
    Symbol(",", ["comma", "coma"]),
    Symbol(".", ["period", "full stop"], ["peridot"]),
    Symbol(";", None, ["flicker"]),
    Symbol(":", None, ["blinker"]),
    ...
    Symbol("=", None, ["equals"]),
    Symbol("+", None, ["surplus"]),
    Symbol("~", None, ["squiggly"]),
    Symbol("_", None, ["underscore"]),
    Symbol("(", None,["L thesis", "left thesis"]),
    Symbol(")", None,["R thesis", "right thesis"]),
    Symbol("[", None,["L block","left block"]),
    Symbol("]", None, ["R block", "right block"]),
    Symbol("/", None, ["whiplash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["L visage", "left visage"]),
    Symbol("}", None, ["R visage", "right visage"]),
    Symbol("<", None, ["L sharp", "left sharp"]),
    Symbol(">", None, ["R sharp", "right sharp"]),
    #Symbol("^", None, ["caret"]),
    Symbol("|", None, ["pipe"]),
    Symbol("'", None, ["apostrophe"]),
    Symbol('"', None, ["double trough"]),
]
